...
```sh
k3d cluster create openbalena -c ./open-balena/k3d-default.yaml
helm dependency update ./open-balena/helm
...
----
### Using the provided jobs to generate the configuration
...
You can use both HAproxy and Traefik
...
$ helm dependency update open-balena-helm/open-balena
...
Comment out the dependency to haproxy-ingress in open-balena-helm/Chart.yaml
...
kubectl apply -f open-balena-helm/traefik-enable-access-logs-and-add-tunnel-entrypoint.yml
...
helm install openbalena open-balena-helm/open-balena -f ./open-balena-helm/kubernetes.yaml --debug > open-balena-helm/install.log
```
...
```sh
helm upgrade openbalena open-balena-helm/open-balena -f ./open-balena-helm/kubernetes.yaml --debug > open-balena-helm/install.log
```
